...
class SortJobNatureModel {
  int status;
  String message;
  Response response;
  Meta errors;

  SortJobNatureModel({this.status, this.message, this.response, this.errors});

  SortJobNatureModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
