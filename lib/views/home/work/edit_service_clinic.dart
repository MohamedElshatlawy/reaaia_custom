...
class EditServiceClinic extends StatefulWidget {
  ...
  final int index;
  EditServiceClinic({@required this.serviceModel,@required this.index});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  CustomTextField(
                    initialValue: widget.serviceModel.serviceDesc,
                    filledColor: Colors.white,
                  ...
                  SizedBox(height: ScreenUtil().setHeight(15)),
                  CustomTextField(
                    initialValue: widget.serviceModel.serviceRequirements,
                    filledColor: Colors.white,
                  ...
                  SizedBox(height: ScreenUtil().setHeight(15)),
                  CustomTextField(
                    initialValue: widget.serviceModel.serviceCost,
                    filledColor: Colors.white,
                    lablel: ' Service Cost',
                    hasBorder: true,
                    onSaved: (val) {
                  ...
                  SizedBox(height: ScreenUtil().setHeight(15)),
                  CustomTextField(
                    initialValue: widget.serviceModel.serviceDiscount,
                    filledColor: Colors.white,
                    lablel: ' DisCount %',
                    hasBorder: true,
                    onSaved: (val) {
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      if (pickedImages != null) {
                        setState(() {
                          images = pickedImages;
                          _serviceModel.images=pickedImages;
                        });
                        ...
                        pressed: () {
                          if (_formKey.currentState.validate()) {
                            ...
                            if(images.isNotEmpty){
                              Provider.of<ClinicsProvider>(context,listen: false).editServiceClinic(widget.index,_serviceModel);
