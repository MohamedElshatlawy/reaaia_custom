      ...
      child: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: Icon(ReaaiaIcons.reaaia_icon),
            label: 'Reaaia',
          ),
          BottomNavigationBarItem(
            icon: Icon(ReaaiaIcons.chat_icon),
            label: 'Chat',
            backgroundColor: Colors.green,
          ),
          BottomNavigationBarItem(
            icon: Icon(ReaaiaIcons.icon),
            label: 'Care+',
            backgroundColor: Colors.purple,
          ),
          BottomNavigationBarItem(
            icon: Icon(ReaaiaIcons.work_icon),
            label: 'Work',
            backgroundColor: Colors.pink,
          ),
          BottomNavigationBarItem(
            icon: Icon(ReaaiaIcons.account_icon),
            label: 'Account',
            backgroundColor: Colors.pink,
          ),
        ],
